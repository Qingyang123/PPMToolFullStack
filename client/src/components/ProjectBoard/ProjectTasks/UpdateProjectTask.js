...
class UpdateProjectTask extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        const { id, projectSequence, summary, acceptanceCriteria, status, priority, dueDate, projectIdentifier } = nextProps.project_task;
    ...
    render() {
        ...
        const { projectSequence, summary, projectIdentifier, acceptanceCriteria, status, priority, dueDate, errors } = this.state;
